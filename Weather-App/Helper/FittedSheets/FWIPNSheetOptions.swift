...
public struct FWIPNSheetOptions {
    public static var `default` = FWIPNSheetOptions()
    
    public enum FWIPNTransitionOverflowType {
    ...
    public var FWIPNTransitionOverflowType: FWIPNTransitionOverflowType = .automatic
    ...
    public init(pullBarHeight: CGFloat? = nil,
        ...
        let defaultOptions = FWIPNSheetOptions.default
    ...
    @available(*, unavailable, message: "cornerRadius, minimumSpaceAbovePullBar, gripSize and gripColor are now properties on FWIPNSheetViewController. Use them instead.")
    public init(pullBarHeight: CGFloat? = nil,
                gripSize: CGSize? = nil,
